...
$link = "http://localhost/ISD-Hanu/php/reset1.php?key=".$key."&&email=".$email."&&username=".$username;
...
<div class="container-fluid">
	<div class="main">
		<div class="row">
			...
			<form method="POST" action="resetPassword1.php"  class="form beta-form-checkout">
